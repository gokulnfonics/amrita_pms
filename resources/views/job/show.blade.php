                                ...
                                <div class="d-flex flex-column flex-sm-row pb-5">
                                    <div class="flex-root d-flex flex-column fw-semibold fs-4">
                                        <span class="d-inline-flex align-items-center">
                                            <i
                                                class="fa-solid fa-building me-2"></i>{{ $job->user->first_name ?? 'Unknown Company' }}
                                        </span>
                                    </div>
                                    <div class="flex-root d-flex flex-column fw-semibold fs-4">
                                        <span class="d-inline-flex align-items-center">
                                    ...
                                    <div class="flex-root d-flex flex-column fw-semibold fs-4">
                                        <span class="d-inline-flex align-items-center">
                                            <i
                                                class="fa-regular fa-calendar me-2"></i>{{ \Carbon\Carbon::parse($job->submission_date)->format('d M Y') }}
                                        </span>
                                    </div>
                                </div>
                                <div class="pb-5">
                                    <div class="fs-4 fw-semibold">Salary :
