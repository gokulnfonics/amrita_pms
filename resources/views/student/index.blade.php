									...
									<td class="text-center">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
											...
											<div class="menu-item px-3">
												<a href="{{ route('student.show', ['student' => $std->id]) }}"  class="menu-link px-3" data-kt-customer-table-filter="delete_row">View</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="javascript:void(0)" onclick="removestudent('{{$std->id}}')" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Delete</a>
											</div>
											<!--end::Menu item-->
										</div>
										<!--end::Menu-->
	...
	function removestudent(catid) {
		swal({
			...
			.then((willDelete) => {
				if (willDelete) {
					$.ajax({
						url: "{{ route('student.deletestudent') }}",
						type: 'POST',
						data: {
							_token: '{{ csrf_token() }}',
							id: catid,
